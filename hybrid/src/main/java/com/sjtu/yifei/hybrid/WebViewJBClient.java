 ...
 * author: yifei
 * created at 18/10/25 下午10:28
 */
@SuppressLint("JavascriptInterface")
public class WebViewJBClient extends WebViewClient {
    ...
    public WebViewJBClient(WebView webView) {
        this(webView, null);
    }


    public WebViewJBClient(WebView webView, WVJBHandler messageHandler) {
